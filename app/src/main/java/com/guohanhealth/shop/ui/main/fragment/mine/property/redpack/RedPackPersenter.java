...
public class RedPackPersenter extends BasePresenter<RedPackView, PredepositModel> {

    public void redpacketList(String key, String curpage) {
        mRxManager.add(mModel.redpacketList(key, curpage).subscribe(info -> {
            mView.getData(info);
    ...
    public void getRedPack(String key, String pwd_code, String captcha, String codekey) {
        Api.post(ApiService.RP_PWEX, new FormBody.Builder()
                        .add("key", key)
