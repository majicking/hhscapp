...
import com.guohanhealth.shop.ui.main.fragment.mine.collect.StoreCollectFragment;
...
public class ReturnActivity extends BaseActivity implements OnFragmentInteractionListener {
    ...
    ReturnGoodsFragment mReturnGoodsFragment;

    @Override
    protected void initView(Bundle savedInstanceState) {
        back.setOnClickListener(v -> finish());
        mFragments = new ArrayList<>();
        mRefundFragment = RefundFragment.newInstance("", "");
        mReturnGoodsFragment = ReturnGoodsFragment.newInstance("", "");
        mFragments.add(mRefundFragment);
        mFragments.add(mReturnGoodsFragment);
